...
def index(request):
    ...
    user = Tblassets.objects.get(firstname='Brooklynn')
...
def contactTracing(request):
    return render(request, 'pages/contactTracing.html')

def assetManagement(request):
    return render(request, 'pages/assetManagement.html')

def changePermissions(request):
    return render(request, 'pages/changePermissions.html')

def homepage(request):
    return render(request, 'pages/homepage.html')

def locationSurveillance(request, mode_id):
    return render(request, 'pages/locationSurveillance.html')
